...
* L'outil Image Builder offre maintenant une méthode nouvelle et améliorée pour créer des modèles (blueprints) et des images dans sa propre console Web.
...
* Une nouvelle règle concernant la fin des sessions inactives a été ajoutée au guide de sécurité SCAP.
...
* Le composant `podman` de Linux Systeme Role est désormais disponible
