...
- **La boîte à outils OpenSSL** TLS est mise à niveau vers la version 3.2.2. OpenSSL prend désormais en charge l'extension de compression des certificats et ajoute Brainpool Curves au protocole TLS 1.3
...
Mise à jour de l'implémentation Java par défaut vers `java-17-openjdk` :
