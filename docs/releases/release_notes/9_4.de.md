...
- Justieren Sie die Optionen für ein Profil und fügen Sie sie Ihren Blueprint-Anpassungen hinzu. Sie können dies erreichen, indem Sie Optionen zum Hinzufügen und Entfernen von Regeln auswählen und abwählen.
