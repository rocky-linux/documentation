...
Eine vollständige Liste der meisten Änderungen finden Sie in den [Upstream-Release-Notes, hier](https://access.redhat.com/documentation/en-us/red_hat_enterprise_linux/9/html/9.3_release_notes/index).
...
- Der Treiber `pcsc-lite-ccid` für USB-Chip-/Smartcard-Interface-Device (CCID) und Integrated-Circuit-Card-Device (ICCD) wurde auf Version 1.5.2 aktualisiert.
