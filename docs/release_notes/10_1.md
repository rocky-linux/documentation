...
The Image Builder tool is now able to create WSL2 and Vagrant (libvirt) images.
...
For further information about desktop application changes please take a look at the [10.0 release notes](https://docs.rockylinux.org/release_notes/10_0/).
