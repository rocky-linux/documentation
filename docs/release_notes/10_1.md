...
As with all Rocky Linux releases, this release note covers numerous enhancements, changes, and new features. Since this is the first minor release for 10, some 10.0 content is deliberately preserved here for completeness.
