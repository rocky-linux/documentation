...
* Optional `guest-agents` group is no-longer available in the *Minmial Install* and *Custom Operating System* environments, and is only available in *Server* and *Server with GUI*:
