...
Були деякі речі, які ми мали привести в порядок і вирішити, але ми з великим задоволенням, що цей випуск містить офіційну прокладку, підписану Rocky Linux. Ось повний потік огляду прокладки: [https://github.com/rhboot/shim-review/issues/194](https://github.com/rhboot/shim-review/issues/194).
