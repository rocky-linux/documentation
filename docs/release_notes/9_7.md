...
- system-wide cryptographic policies: You can enable support for PQC (Post-Quantum Cryptography) through the new PQ subpolicy. There are additions and improvements to many applications and tools for corresponding algorithms in PQC.
