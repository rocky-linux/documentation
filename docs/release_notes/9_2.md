...
To the already available Workstation/Workstation Lite/KDE/XFCE/MATE live images, the Cinnamon Live image has been added in both x86_64 and aarch64. Experimentally a build for ppc64le live images has been added.
...
* An aarch64 64k kernel got added (`kernel-64k`)
