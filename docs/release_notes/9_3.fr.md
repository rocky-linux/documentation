...
Vous pouvez trouver une liste détaillée de la plupart des changements dans les [notes de version en amont qui se trouvent ici](https://access.redhat.com/documentation/en-us/red_hat_enterprise_linux/9/html/9.3_release_notes/index).
...
- Le pilote pcsc-lite-ccid USB Chip/Smart Card Interface Device (CCID) et Integrated Circuit Card Device (ICCD), rebasé est sur la version 1.5.2.
