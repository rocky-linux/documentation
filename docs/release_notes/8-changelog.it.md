...
È stata implementata la firma dei metadati del repository sperimentale. Se vuoi provarlo, imposta la seguente opzione nei file Rocky-X.repo:
...
* rocky-release
  ...
  * Aggiungi i repository devel e debuginfo per il futuro stato
