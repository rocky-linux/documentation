...
За потреби ви також можете змінити наш приклад сценарію, реалізуючи блокування та повну синхронізацію. Його можна знайти за адресою <https://github.com/rocky-linux/rocky-tools/blob/main/mirror/mirrorsync.sh>.
...
Отримайте доступ до менеджера дзеркал Роккі тут: <https://mirrors.rockylinux.org/mirrormanager/>
...
- «URL-адреса організації» – URL-адреса компанії/навчального закладу/організації, наприклад, <https://rockylinux.org/>
