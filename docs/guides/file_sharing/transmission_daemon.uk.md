...
```
Пакет `transmission-daemon` наразі відсутній у EPEL. Ймовірно, його буде зібрано. Команда Docs продовжить тестувати його доступність у EPEL, якщо дозволить час. Наразі єдиним варіантом є зібрати пакет transmission з вихідного коду, а інструкції для цього наразі відсутні тут. 
```
...
Transmission — це популярний клієнт BitTorrent з відкритим кодом, який має кілька фронтендів та серверів. Тут ви встановите бекенд безголового «демона».
