...
Якщо ви користуєтеся Rocky Linux 10, вам потрібно додати репозиторій RPM. Автор використовує для цього `vi`, але якщо ви віддаєте перевагу `nano` або щось інше, замініть його в:
...
Після встановлення пакетів вам потрібно налаштувати Tor:
