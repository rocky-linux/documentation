...
Наприклад, файл `ks.cfg` доступний з віртуальної машини за цією URL-адресою в нашій лабораторії: <http://fileserver.rockylinux.lan/packer/rockylinux/8/ks.cfg>. Вам потрібно буде налаштувати щось подібне, щоб використовувати цей метод.
