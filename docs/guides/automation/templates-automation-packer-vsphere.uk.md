...
1. Додайте репозиторій HashiCorp до доступних сховищ у нашій системі Rocky Linux:

    ```bash
    sudo dnf config-manager --add-repo https://rpm.releases.hashicorp.com/fedora/hashicorp.repo
    ```

1. Встановіть пакувальник:
...
1. З оболонки або терміналу завантажте його за допомогою інструменту `wget`:
...
1. Щоб розпакувати завантажений архів, виконайте наступну команду в оболонці:
...
1. Перемістіть програму Packer до папки bin:
...
Щоб дізнатися більше про файли Kickstart та про те, як їх розгортати в Rocky Linux, ознайомтеся з [посібником з файлів Kickstart та Rocky Linux](kickstart-rocky.md).
