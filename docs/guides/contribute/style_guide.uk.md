...
- Заголовки, як правило, слід створювати з великої літери у стилі речень: пишіть з великої літери лише перше слово та власні іменники. Зробіть форматування заголовків однаковим у всьому документі.
...
!!! info "Використання великої літери в заголовках речень"
    ...
    Поточний стандарт для документації — це написання речень з великої літери. Люди, які використовують `vale` та інші мовні лінтери, побачать, що вони пропонують використовувати написання з великої літери в стилі речень. Значна частина документації, створеної в нашому пулі документації, використовує цей стиль написання заголовків з великої літери. Це відрізняється від Чиказького посібника зі стилю, але оскільки галузь тяжіє до цього стилю в заголовках документації, до цього документа внесено зміни, щоб включити цю рекомендацію.
