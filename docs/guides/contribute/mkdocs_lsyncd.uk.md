...
* Довідка про LXD – це довгий документ про [створення та використання LXD на сервері](../../books/lxd_server/00-toc.md), але ви будете використовувати лише базову інсталяцію на нашій робочій станції Linux
...
* Наш інтерфейс мосту працює на 10.56.233.1, а наш контейнер працює на 10.56.233.189 у наших прикладах, однак ваші IP-адреси для мосту та контейнера будуть різними
...
Наш перший крок — створити контейнер LXD. Тут можна використовувати стандартні параметри контейнера (інтерфейс мосту).
...
Встановлення `lsyncd` відрізняється залежно від вашої версії Linux. [У цьому документі](../backup/mirroring_lsyncd.md) описано способи встановлення на Rocky Linux, а також із джерела. Якщо ви використовуєте інші типи Linux (Ubuntu, наприклад), вони зазвичай мають власні пакети, але мають нюанси.
