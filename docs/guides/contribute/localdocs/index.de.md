...
Die Verwendung einer lokalen Kopie der Dokumentation ist ein Schritt im Entwicklungsprozess für diejenigen, die der Philosophie von
`docs as code`
folgen, einem Workflow für die Dokumentation, der dem der Codeentwicklung ähnelt. Obwohl nicht im Abschnitt zur lokalen Dokumentation zu finden, passt [ein Leitfaden für Expertenbeiträge](../expert_contributing.md) auch in die lokalen Dokumentationsleitfäden, enthält aber viele andere Referenzen, die für alle Mitwirkenden von Interesse sein könnten. Sie können dieses Dokument zusammen mit den anderen hier aufgeführten Dokumenten einsehen und es könnte sich als nützlich erweisen.
