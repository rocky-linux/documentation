...
L'utilisation d'une copie locale de la documentation est une étape du processus de développement pour ceux qui adhèrent à la philosophie du `docs as code`, un flux de travail pour la documentation semblable au développement de code. Bien qu'il ne figure pas dans la section de documentation locale, [un guide de contribution d'expert](../expert_contributing.md) s'intègre également dans les guides de documentation locaux, mais comprend de nombreuses autres références qui pourraient intéresser tous les contributeurs. Vous pouvez consulter ce document en parallèle avec les autres documents disponibles ici et il pourrait vous être utile.
