...
!!! tip "Підказка"
    ...
    Ви можете створити окремі середовища для `mkdocs`, використовуючи одну з цих двох процедур:

    * [Локальна документація - Docker](rockydocs_web_dev.md)
    * [Локальна документація - LXD](mkdocs_lsyncd.md)
