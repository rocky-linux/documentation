...
DNF зазвичай використовується в Rocky Linux, Fedora, RHEL (Red Hat Enterprise Linux) 8 і новіших версіях та інших дистрибутивах Linux, які прийняли його як менеджер пакетів. Його метою є надання користувачам та адміністраторам сучаснішого та ефективнішого досвіду управління пакетами.
