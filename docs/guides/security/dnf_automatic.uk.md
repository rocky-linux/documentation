...
Безпека вашої інформаційної системи буде посилена. `dnf-automatic` — це додатковий інструмент, який дозволить вам цього досягти.
...
Ви можете встановити `dnf-automatic` із репозиторіїв rocky:
