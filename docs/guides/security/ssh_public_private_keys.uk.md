...
- Сервер або робочі станції Linux із встановленим _openssh_
...
Тепер у вашому каталозі _.ssh_ має бути пара відкритих і закритих ключів типу RSA:
...
Вам потрібно надіслати відкритий ключ (_id_rsa.pub_) на кожну машину, до якої ви збираєтеся отримати доступ. Перш ніж це зробити, вам потрібно переконатися, що ви можете підключитися до серверів, на які ви надсилаєте ключ, через SSH. У цьому прикладі використовуються три сервери.
...
Повторіть цей крок з кожною з ваших трьох машин. Це заповнить файл _authorized_keys_ на кожному сервері вашим відкритим ключем.
