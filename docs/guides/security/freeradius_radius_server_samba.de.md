...
Nach der Einrichtung des FreeRADIUS-Servers konfigurieren Sie einen RADIUS-Client auf dem MikroTik-Switch des Autors als kabelgebundenen 802.1X-Client:
