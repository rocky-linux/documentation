...
Коли `firewalld` став менеджером брандмауера за замовчуванням у CentOS 7 (спочатку представленим у Fedora 18), автор продовжував використовувати `iptables`. На це було дві причини. По-перше, доступна на той час документація для `firewalld` використовувала спрощені правила й не показувала, як `firewalld` захищав сервер *аж до рівня IP*. По-друге, автор мав понад десятиліття досвіду роботи з `iptables`, і було легше продовжувати використовувати його замість вивчення `firewalld`.
