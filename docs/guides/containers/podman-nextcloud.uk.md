...
Звідти ви зможете вказати свій браузер на IP-адресу вашого сервера. Якщо ви дотримуєтеся інструкцій і маєте таку ж IP-адресу, як у нашому прикладі, ви можете підставляти її сюди (наприклад, <http://your-server-ip>) і спостерігати, як Nextcloud працює.
