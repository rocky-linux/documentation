...
Перш ніж продовжити, перезавантажте сервер. Це можна зробити за допомогою команди <code>reboot</code> або з панелі адміністратора VPS/хмарного хостингу.
...
Використовуйте команду за замовчуванням для встановлення Nginx:
