...
??? note "Rocky Linux 8 Slurm Deployment Playbook"
...
Task `Create the slurm.conf configuration file on each node` uses a configuration generated by the Slurm Configurator Tool^6^. The main lines of note are:
...
??? note "Rocky Linux 9 Slurm Deployment Playbook"
...
??? note "Rocky Linux 10 Slurm Deployment Playbook"
...
6. "Slurm Configuration Tool" by SchedMD [https://slurm.schedmd.com/configurator.html](https://slurm.schedmd.com/configurator.html)
