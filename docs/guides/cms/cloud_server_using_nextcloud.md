...
* We will be applying concepts from the Apache sites enabled document (linked to later in this document) for directory setup in the .zip file method.
...
To see how this changes the output of the module list, run that command again and you will see the "[e]" next to 8.0:
...
We need to set the timezone for PHP. To do this:
