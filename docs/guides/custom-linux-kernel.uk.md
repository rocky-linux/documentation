...
Відповідний файл карти для цього буде розташований за адресою `~/build/kernel/System.map`. На етапі встановлення вам знадобляться обидва файли.
...
`System.map` дозволяє Linux перетворювати ці шістнадцяткові числа на читабельні імена, що спрощує налагодження. Хоча це в основному на користь розробників, це може бути зручно під час повідомлення про проблему.
