...
Встановлення відбуватиметься відповідно до [офіційних інструкцій](https://docs.librenms.org/Installation/Install-LibreNMS/).  Пояснення та незначні зміни в цій процедурі роблять цю процедуру кращою за чудовий документ.
