...
Salvare le modifiche e uscire dal file. Se questo è l'unico servizio Web che verrà eseguito su questa macchina, è possibile rimuovere il vecchio file <www.conf> copiato:
