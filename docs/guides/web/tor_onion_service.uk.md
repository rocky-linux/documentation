...
```
`tor` наразі відсутній в EPEL. Ймовірно, його буде зібрано. Команда документації продовжить тестувати доступність в EPEL, якщо дозволить час. Наразі єдиний варіант — створити `tor` з вихідного коду, а інструкції для цього наразі відсутні тут.
```
