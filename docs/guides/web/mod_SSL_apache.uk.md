...
Веб-сервер Apache існує вже багато років. `mod_ssl` забезпечує підвищений рівень безпеки для веб-сервера та може бути встановлений майже на будь-якій версії Linux.
...
- Можливість запускати команди як _root_ або `sudo` для підвищення привілеїв.
