...
Заглушка добре задокументована, але майте на увазі, що це аж ніяк не вичерпний сценарій! Є багато інших процедур, які можна додати. Якщо **у вас** є приклади, які добре вписуються в цю заготовку, будь ласка, додайте деякі зміни:
