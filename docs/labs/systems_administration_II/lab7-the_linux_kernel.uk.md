...
6. Використовуйте `rpm`, щоб перевірити та встановити завантажене ядро*.rpm, щоб переконатися, що всі його залежності виконуються. Впишіть:
...
8.  Знову запустіть `rpm` із параметром тестування, щоб перевірити, чи можна оновити пакет ядра. Впишіть:
...
15. Вийдіть із програми налаштування ядра, двічі натиснувши клавішу esc на клавіатурі. Вихід із конфігуратора ядра примусово збереже ваші зміни у файлі .config у корені дерева вихідних кодів ядра.

16. З’явиться діалогове вікно з пропозицією зберегти нову конфігурацію. Переконайтеся, що вибрано «Так», потім натисніть <kbd>ENTER</kbd>.
