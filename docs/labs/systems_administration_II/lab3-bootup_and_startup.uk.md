...
2. Виконайте команду `ls`, щоб переглянути шлях до віртуальної файлової системи /proc/<PID>/exe, а також ім’я та шлях до виконуваного файлу процесу з ідентифікатором процесу. Впишіть:
