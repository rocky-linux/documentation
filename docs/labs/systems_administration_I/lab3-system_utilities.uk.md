...
3. Введіть наведену нижче фразу в пустому рядку та натисніть <kbd>ENTER</kbd>.
...
16. Переконайтеся, що ви все ще перебуваєте в каталозі «завантажень» локальної машини. Перелічити файли в папці завантажень?
...
Це додасть новий вихід до файлу замість його заміни. Впишіть:
...
Команда "rm" використовується для видалення файлів або каталогів. Ви збираєтеся використати `rm`, щоб видалити деякі з файлів, створених у попередніх вправах.
...
3. Поверніться до домашнього каталогу (/root) і видаліть каталог «folder2».
    ...
    Щоб використати `rm` для видалення папки, потрібно використати перемикач «–r»:
...
Утиліта `знайти` існує вже давно. Він рекурсивно сканує каталоги, щоб знайти файли, які відповідають заданому критерію.

Загальний синтаксис `find` такий:
