...
3. Спробуйте пінгувати локальний шлюз. Впишіть:
    ...
    !!! Question "Питання"
      За допомогою якого механізму ваша система може правильно розпізнати назву `_gateway` у належну IP-адресу для вашого локально налаштованого шлюзу за умовчанням?
