...
4. Перелічіть ключі, які зараз є у вашому keyring. Впишіть:
    ...
    !!! question "Лабораторне завдання:"
     ...
     Перерахуйте приховані каталоги у вашому домашньому каталозі. Як називається новий доданий каталог?
...
2. Перегляньте довідкову сторінку для `sshd_config`.

    !!! question "Питання"
   
        Що роблять наступні параметри?
...
2. Використовуйте програму `ssh-keygen`, щоб створити ключ хоста з такими характеристиками:
    ...
    !!! question "Питання"
        ...
        Що потрібно зробити, щоб демон sshd використовував ключ хоста, який ви щойно згенерували?
...
6. Перебуваючи на сервері serverXY, спробуйте віддалено перезавантажити serverPR як користувач `ying`. Впишіть:
    ...
    !!! Questions "Питання"
     ...
     Чи міг користувач ying віддалено перезавантажити serverPR? Чому ying не може віддалено перезавантажити serverPR?
...
8. З сервера XY спробуйте віддалено перезапустити службу `sshd`, яка працює на сервері PR від імені користувача `ying`. Впишіть:
    ...
    !!! Question "Питання"
     ...
     - Чи міг користувач ying віддалено переглянути статус служби sshd на serverPR? 
