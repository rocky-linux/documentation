...
Ви помітите, що версія Rocky 8 за замовчуванням — 7.2, яка на момент написання цієї статті вже не підтримується.
...
Так само, як і Apache та його модуль `mod_status`, PHP-FPM пропонує сторінку, що вказує на стан процесу.
