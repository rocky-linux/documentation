...
З [Короткий опис rsync](01_rsync_overview.md) ми знаємо, що rsync — це інструмент для інкрементальної синхронізації. Щоразу, коли виконується команда `rsync`, дані можна синхронізувати один раз, але дані не можна синхронізувати в режимі реального часу. Як це зробити?
...
Потім скористайтеся командою `scp`, щоб завантажити файл відкритого ключа на сервер. Наприклад, я завантажую цей відкритий ключ користувачеві **testrsync**
