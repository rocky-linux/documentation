...
!!! warning "Примітка щодо Rocky Linux 9.x та `iptables`"
...
!!! warning
    ...
    Зміна цілі зони `firewalld` _має_ виконуватися за допомогою параметра `--permanent`, тож ми можемо також просто ввести цей прапорець в інших наших командах і відмовитися від `--runtime-to-permanent` варіант.
