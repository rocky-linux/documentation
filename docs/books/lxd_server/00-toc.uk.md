...
* **Розділ 3: Ініціалізація LXD і налаштування користувача** Розглядається базова ініціалізація та параметри. Це також стосується налаштування нашого непривілейованого користувача, якого ми будемо використовувати протягом майже всього процесу.
