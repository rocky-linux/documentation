...
Перший рядок, який потрібно написати в будь-якому сценарії, - це вказати назву двійкового файлу оболонки, який буде використано для його виконання.
Якщо ви хочете використовувати оболонку `ksh` або інтерпретовану мову `python`, вам слід замінити рядок:
...
Він починається з символів `#!`, за якими йде шлях до двійкового файлу інтерпретатора команд, який потрібно використовувати.
