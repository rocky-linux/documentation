...
**Змінні середовища** та **системні змінні** – це змінні, що використовуються системою для її роботи. За згодою імена пишуться великими літерами.
...
| `USER`, `USERNAME` та `LOGNAME` | Ім'я користувача, підключеного до сеансу.                          |
...
Змінна дійсна лише в середовищі процесу сценарію оболонки. Щоб **дочірні процеси** скрипта знали змінні та їхній вміст, їх необхідно експортувати.
