...
Якщо цільовим вузлом є `hostname1` з `group1`, змінні, що містяться у файлах `hostname1.yml` та `group1.yml`, будуть завантажені автоматично. Це чудовий спосіб зберігати всі дані для всіх ваших ролей в одному місці.
