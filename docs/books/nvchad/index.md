...
Nvchad is a project created for the purpose of providing, through a custom configuration of Neovim, a starting point on which to build your own IDE (**I**ntegrated **D**evelopment **E**nvironment) with minimal effort.
