...
| opzione                                                                     | descrizione                                                                                                                                                                 |
| :-------------------------------------------------------------------------- | :-------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| -f program-file<br/>--file program-file                                     | Lettura dei file sorgente del programma `awk` da file                                                                                                                       |
...
|                                 ++<br/>--                                | Incrementale<br/>Decrescente                                                                   |
|                               +<br/>-<br/>!                              | Segno matematico più<br/>Segno matematico meno<br/>Negazione                                   |
|                              \*<br/>/<br/>%                              | Segno di moltiplicazione matematica<br/>Segno di divisione matematica<br/>Operazione di modulo |
|                                    in                                    | Elementi di una matrice                                                                        |
|          &&<br/>\\|\\|         | Operazioni logiche AND<br/>Operazioni logiche OR                                               |
...
| :----------------------------------------------------------------------------- | :------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| getline                                                                        | Leggere il successivo record di riga corrispondente e assegnarlo a "$0". <br/>Il valore di ritorno è 1: indica che sono stati letti i record di riga pertinenti. <br/>Il valore di ritorno è 0: indica che l'ultima riga è stata letta <br/>Il valore di ritorno è negativo: Indica che si è verificato un errore |
