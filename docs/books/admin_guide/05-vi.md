...
At this time, all keyboard typing is interpreted as commands and the corresponding operations are performed. These are essentially commands for editing text (copy, paste, undo, ...).
