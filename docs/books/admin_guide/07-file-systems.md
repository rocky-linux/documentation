...
| **b**       | Represents block device file. Includes all kinds of hard drives, USB drives and so on. | 
...
| **l**       | Represents soft link files, also called symbolic link files, similar to shortcuts in Windows. Hard link file, also known as physical link file.| 
