...
| Опція | Опис                                                        |
| ----- | ----------------------------------------------------------- |
| `-e`  | Редагування файлу розкладу за допомогою vi                  |
| `-l`  | Відображення вмісту файлу розкладу                          |
| `-u`  | Вказує користувача, файлом розкладу якого потрібно керувати |
...
| Налаштування | Опис                                                       |
| ------------ | ---------------------------------------------------------- |
| @reboot      | Виконати команду під час перезавантаження системи          |
| @hourly      | Виконувати команду щогодини                                |
