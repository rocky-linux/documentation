...
:heavy_check_mark: 시스템 트리 내에서 **이동**하세요.   
:heavy_check_mark: 텍스트 파일을 **만들고** 내용을 **표시**하고 ** 수정**하세요.   
:heavy_check_mark: 가장 유용한 Linux 명령어를 **사용**하세요.
...
| `-c` | 현재 세션의 기록을 삭제합니다(`.bash_history` 파일의 내용 제외). |
...
자주 사용되는 시퀀스 중에서, 다음을 언급할 수 있습니다.
