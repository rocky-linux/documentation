...
| `rockstar`      | Pour un fichier de type lien physique : nombre de liens physiques.                                                  |
| `4096`          | Groupe propriétaire.                                                                                                |
...
Les méta-caractères se substituent à un ou plusieurs caractères (voire à une absence de caractère) lors d’une recherche. Ces méta-caractères sont également connus sous le nom de caractères jokers. Ils sont combinables. Le caractère `*` remplace une chaîne composée de plusieurs caractères quelconques. Le caractère `*` peut également représenter une absence de caractère.
