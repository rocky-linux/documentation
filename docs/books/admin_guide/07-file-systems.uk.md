...
| `-l  номер` | Крім використання одиниці ємності жорсткого диска, можна також використовувати кількість PE. Один PE дорівнює 4 МБ. |
...
| BRID    | Його функція полягає в тому, щоб визначити, чи можна використовувати пристрій для завантаження.                                                                                                                      |
...
| Опція | Опис                                                                               |
| ----- | ---------------------------------------------------------------------------------- |
| `-n`  | Монтувати без запису в `/etc/mtab`.                                                |
| `-t`  | Щоб вказати тип файлової системи для використання.                                 |
| `-а`  | Монтує всі файлові системи, згадані в `/etc/fstab`.                                |
...
| Опція | Опис                                                            |
| ----- | --------------------------------------------------------------- |
| `-n`  | Розмонтування без запису до `/etc/mtab`.                        |
| `-r`  | Якщо розмонтувати не вдалося, перемонтуйте як лише для читання. |
| `-f`  | Примусово відключити.                                           |
| `-а`  | Відмонтуйте всі файлові системи, згадані в `/etc/fstab`.        |
...
|    **b**    | Файл Block device. Включаючи всілякі жорсткі диски, USB-накопичувачі тощо.                                                                                                                |
...
|    **p**    | Файл Pipe. Це особливий тип файлу, основна мета якого – усунути помилки, спричинені одночасним доступом кількох програм до файлу. FIFO - це абревіатура "перший прийшов - перший вийшов". |
|    **l**    | Файли програмних посилань, також звуться файлами символічних посилань, подібні до ярликів у Windows. Файл жорсткого посилання, також відомий як файл фізичного посилання.                 |
...
| Типи посилань            | Опис                                                                                                                                                                                                                                                            |
| ------------------------ | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| файл м'якого посилання   | Ярлик, схожий на Windows. Він має дозвіл 777 і вказує на вихідний файл. Коли оригінальний файл видаляється, зв’язаний файл і вихідний файл відображаються червоним кольором.                                                                                    |
| Файл жорсткого посилання | Вихідний файл має той самий номер _ inode_, що й файл із жорстким посиланням. Їх можна оновлювати синхронно, включаючи вміст файлу та час його зміни. Не можна перетинати розділи, не можна перетинати файлові системи. Не можна використовувати для каталогів. |
