...
Після опції може бути кілька аргументів:
...
| Клавіші            | Функція                                                                   |
| ------------------ | ------------------------------------------------------------------------- |
| <kdb>!!</kdb>      | Відкликає останню введену команду.                                        |
| <kdb>!n</kdb>      | Відкликає команду за номером у списку.                                    |
| <kdb>!string</kdb> | Викликає останню команду, яка починається з рядка.                        |
| <kdb>↑</kdb>       | Переміщується у вашій історії, повертаючись у часі від останньої команди. |
| <kdb>↓</kdb>       | Переміщується у вашій історії, рухаючись вперед у часі.                   |
...
| Опція | Опис                                                                                                                  |
| ----- | --------------------------------------------------------------------------------------------------------------------- |
| `-а`  | Відображає всі файли, навіть приховані. Приховані файли в Linux починаються з `.`.                                    |
