...
<ul>
  <li>
    a <code>+</code> : цей процес є наступним процесом, який запускається за замовчуванням з <code>fg</code> або <code>bg</code> ;
  </li>
  <li>
    a <code>-</code> : цей процес є наступним процесом, який отримає <code>+</code> ; <code>+</code>
  </li>
</ul>
