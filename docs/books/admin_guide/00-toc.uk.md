...
Резервне копіювання та відновлення є важливою інформацією для системного адміністратора. Linux поставляється з багатьма програмними рішеннями для покращення резервного копіювання (rsnapshot, lsyncd тощо). Важливо знати основні компоненти резервного копіювання, які існують в операційній системі. У цьому розділі ми досліджуємо два інструменти: `tar` та менш поширений `cpio`.
