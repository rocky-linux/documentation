...
当您打开一个文档时，您会在右侧看到一个“目录”，其中包含该文档的可单击导航链接（对于移动设备，请尝试横向）。对于长文档而言，如 [Release Notes](release_notes/8.4.md)，目录可以很容易地在文档中跳转。如果您正在阅读长文档并想返回顶部，请按 <kbd>pg up</kbd> 或者使用鼠标滚轮的方式，会看到屏幕顶部出现“返回顶部”按钮。
